      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="pt-4 flex gap-3">
                  ...
                  <div className="flex-1 bg-[#a852e5]/10 rounded-lg p-3 text-center border border-[#a852e5]/20">
                    ...
                    <div className="text-[10px] text-[#a852e5] font-bold">
                      EXPORT PDF
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-24 pt-10 border-t border-gray-100">
          <h3 className="text-center text-2xl font-bold text-gray-900 mb-12">
            How VCNITI Planner Works
          </h3>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "Input Details",
                desc: "Enter project area, floors & quality.",
                icon: <FileText className="text-blue-600" />,
              },
              {
                title: "AI Generation",
                desc: "Get BOQ & brand suggestions instantly.",
                icon: <Calculator className="text-[#a852e5]" />,
              },
              {
                title: "Procure",
                desc: "Compare prices & order delivery.",

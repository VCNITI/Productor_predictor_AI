          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Stop guessing material quantities. Our AI Planner analyzes your
                project parameters to generate precise BOQs, cost estimates, and
                procurement schedules instantly.
              </p>

              <ul className="space-y-3 mb-10">
                {[
                  "Instant Material Estimation",

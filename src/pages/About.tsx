            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                >
                    <motion.div variants={fadeIn} className="flex items-center gap-2 mb-8">
                        ...
                        <span className="text-sm font-bold tracking-widest text-gray-500 uppercase">Our Mission</span>
                    </motion.div>
                    
                    <motion.h1 variants={fadeIn} className="text-5xl md:text-7xl font-bold text-gray-900 tracking-tighter leading-[1.1] mb-6">
                        Building the <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#a852e5] to-purple-600">Future</span> of <br />
                        Procurement.
                    </motion.h1>

                    <motion.p variants={fadeIn} className="text-xl text-gray-600 leading-relaxed mb-8">
                        VCNITI is India’s first AI-powered Q-commerce ecosystem. We don't just sell materials; we engineer the supply chain for speed, accuracy, and trust.
                    </motion.p>

                    <motion.div variants={fadeIn}>
                         <Button asChild size="lg" className="rounded-full h-14 px-8 bg-gray-900 hover:bg-black text-white text-lg shadow-xl shadow-gray-900/10 transition-transform hover:-translate-y-1">
                ...
                >
                    ...
                    <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white rotate-2 hover:rotate-0 transition-transform duration-500 ease-out">
                         ...
                         <div className="absolute bottom-8 left-8 z-20 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-2xl text-white">
                            <p className="font-bold text-lg">Infrastructure for Tomorrow</p>
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-white/50 shadow-lg">
                        <div className="flex justify-between divide-x divide-gray-200">
                            <div className="px-4 text-center w-full">
                                <div className="text-2xl font-bold text-[#a852e5]">100+</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase mt-1">Projects</div>
                            </div>
                            <div className="px-4 text-center w-full">
                                <div className="text-2xl font-bold text-[#a852e5]">1k+</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase mt-1">Suppliers</div>
                            </div>
                            <div className="px-4 text-center w-full">
                                <div className="text-2xl font-bold text-[#a852e5]">4hr</div>
                                <div className="text-[10px] font-bold text-gray-500 uppercase mt-1">Delivery</div>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="lg:col-span-6 space-y-6 lg:pl-10">
                    <h3 className="text-3xl font-bold text-gray-900 leading-tight">
                        Bridging the gap between <span className="underline decoration-[#a852e5] decoration-4 underline-offset-4">tech</span> and <span className="underline decoration-[#a852e5] decoration-4 underline-offset-4">cement</span>.
                    </h3>
                    <p className="text-gray-600 leading-relaxed text-lg">
                        VCNITI Technologies Private Limited was founded to solve a chaotic problem: construction procurement is slow, opaque, and unpredictable.
                    </p>
                    <p className="text-gray-600 leading-relaxed">
                        We combine advanced algorithms with real-time market data to provide accurate cost estimates, connect buyers with trusted suppliers, and enable seamless project execution.
                    </p>
                    
                    <div className="flex gap-4 pt-4 items-center">
                        <div className="flex -space-x-4">
                            {[1,2,3].map(i => (
                                <div key={i} className="w-12 h-12 rounded-full border-4 border-white bg-gray-200 flex items-center justify-center overflow-hidden shadow-sm">
        ...
        <section id="services" className="py-24 px-6 bg-gray-50">
            <div className="max-w-7xl mx-auto">
                <div className="mb-16 text-center md:text-left">
                     <h2 className="text-4xl font-bold text-gray-900 tracking-tight">Our Ecosystem</h2>
                     <p className="text-gray-500 mt-2 text-lg">Everything you need to build better.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Material Marketplace</h3>
                                <p className="text-gray-500 max-w-md">Connect directly with verified manufacturers and distributors. Get the best market rates delivered to your site.</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">95% accurate cost prediction engines generated in seconds.</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Pro Network</h3>
                                <p className="text-gray-500 text-sm">Access 1000+ architects, contractors & structural engineers.</p>
                            </div>
                        </div>
                    </motion.div>
                        ...
                        <div className="relative z-10 flex flex-col h-full justify-between">
                            ...
                            <div className="flex justify-between items-end">
                                <div>
                                    ...
                                    <p className="text-purple-100 max-w-md">End-to-end tracking from foundation to finish. Monitor progress remotely.</p>
                                </div>
        ...
        <section className="py-24 px-6 bg-gray-950 text-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                 <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div>
                        <Badge variant="outline" className="text-[#a852e5] border-[#a852e5] mb-4 px-4 py-1">Core Technology</Badge>
                        <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Platform Intelligence</h2>
                    </div>

            ...
            >
              <motion.div variants={fadeIn} className="mb-12">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Have a project in mind? Looking for bulk material pricing? Our
                  team matches you with the right solutions instantly.
                </p>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
                ...
                <motion.div
                  variants={fadeIn}
                  className="md:col-span-2 bg-gray-900 rounded-3xl p-6 text-white relative overflow-hidden group"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <a
                      href="mailto:info@vcniti.com"
                      className="text-2xl font-bold flex items-center gap-2 hover:text-[#a852e5] transition-colors"
                    >
                ...
                >
                  ...
                  <a
                    href="tel:9740059699"
                    className="text-lg font-bold text-[#a852e5] hover:underline"
                  >
                    9740059699
                  </a>
                </motion.div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="uppercase text-xs font-bold text-gray-500 tracking-wider">
                              First Name
                            </FormLabel>
                            <FormControl>
                              <Input
                    ...
                    <p className="text-center text-xs text-gray-400 mt-4">
                      Your data is secure. We never share your info with third
                      parties.
                    </p>
                  </form>
                </Form>
